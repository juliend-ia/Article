  ...
  for (var i=0;i<n;i++) {
    ...
    var editIconBtns = window._canEdit
      ? '<div class="card-menu-wrap">'
          ...
          +'<div class="card-menu">'
            +'<div class="card-menu-item" data-action="edit" data-num="'+esc(a.num)+'"><span class="cmi-ico">✏️</span>Modifier</div>'
            +'<div class="card-menu-item card-menu-del" data-action="del" data-num="'+esc(a.num)+'"><span class="cmi-ico">🗑️</span>Supprimer</div>'
          +'</div>'
        +'</div>'
      : '';
    ...
    var editBtns=window._canEdit
      ?'<div class="card-edit-btns" onclick="event.stopPropagation()">'
          ...
          +'<div class="card-menu-wrap">'
            ...
            +'<div class="card-menu">'
              +'<div class="card-menu-item" onclick="event.stopPropagation();closeCardMenus();openOutilEdit(\''+o.id+'\')"><span class="cmi-ico">✏️</span>Modifier</div>'
              +'<div class="card-menu-item card-menu-del" onclick="event.stopPropagation();closeCardMenus();deleteOutil(\''+o.id+'\')"><span class="cmi-ico">🗑️</span>Supprimer</div>'
            +'</div>'
          +'</div>'
        +'</div>'
      :'';
